...
class SimpleProgressDialog : Dialog, DialogInterface.OnDismissListener {
    private var progressImg: ProgressBarCircularIndeterminate? = null
    ...
    fun init() {
        ...
        progressTxt = this@SimpleProgressDialog.findViewById<TextView>(R.id.text1) as TextView
        progressImg = this@SimpleProgressDialog.findViewById<ProgressBarCircularIndeterminate>(R.id.progress) as ProgressBarCircularIndeterminate
    }
